...
- [`apps/web/src/components/ChatView.tsx`](/Users/emre/Documents/GitHub/codewit/apps/web/src/components/ChatView.tsx)
- [`apps/web/src/components/Sidebar.tsx`](/Users/emre/Documents/GitHub/codewit/apps/web/src/components/Sidebar.tsx)
- [`apps/web/src/store.ts`](/Users/emre/Documents/GitHub/codewit/apps/web/src/store.ts)
- [`apps/web/src/composerDraftStore.ts`](/Users/emre/Documents/GitHub/codewit/apps/web/src/composerDraftStore.ts)
- [`apps/web/src/routes/__root.tsx`](/Users/emre/Documents/GitHub/codewit/apps/web/src/routes/__root.tsx)

## What is already going in the right direction

- Normalized state is present in [`store.ts`](/Users/emre/Documents/GitHub/codewit/apps/web/src/store.ts).
- Selector extraction is happening in [`storeSelectors.ts`](/Users/emre/Documents/GitHub/codewit/apps/web/src/storeSelectors.ts).
- Thread reconstruction has started moving into [`threadDerivation.ts`](/Users/emre/Documents/GitHub/codewit/apps/web/src/threadDerivation.ts).
...
[`apps/web/src/routes/__root.tsx`](/Users/emre/Documents/GitHub/codewit/apps/web/src/routes/__root.tsx) currently participates in event routing and coalescing. That works, but the event pipeline would be easier to maintain if it became more explicit:
