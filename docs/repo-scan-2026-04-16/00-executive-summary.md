...
- CI is not superficial. It already runs format, lint, typecheck, tests, browser tests, and desktop build verification in [`.github/workflows/ci.yml`](/Users/emre/Documents/GitHub/codewit/.github/workflows/ci.yml).
...
- [`apps/server/src/codexAppServerManager.ts`](/Users/emre/Documents/GitHub/codewit/apps/server/src/codexAppServerManager.ts)
- [`apps/server/src/wsServer.ts`](/Users/emre/Documents/GitHub/codewit/apps/server/src/wsServer.ts)
- [`apps/desktop/src/main.ts`](/Users/emre/Documents/GitHub/codewit/apps/desktop/src/main.ts)
...
There is useful release documentation in [`docs/release.md`](/Users/emre/Documents/GitHub/codewit/docs/release.md), but there is not yet a matching level of architecture guidance for:
