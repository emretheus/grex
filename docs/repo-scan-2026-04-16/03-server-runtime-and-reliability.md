...
[`apps/server/src/codexAppServerManager.ts`](/Users/emre/Documents/GitHub/codewit/apps/server/src/codexAppServerManager.ts) appears to own too many runtime concerns in one place:
