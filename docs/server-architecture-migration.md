...
This document tracks compatibility constraints for the controlled migration from the current legacy Codewit server toward the newer upstream modular server architecture.
