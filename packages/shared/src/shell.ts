...
const PATH_CAPTURE_START = "__CODEWIT_PATH_START__";
const PATH_CAPTURE_END = "__CODEWIT_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__CODEWIT_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__CODEWIT_ENV_${name}_END__`;
}
