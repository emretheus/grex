...
/**
 * Official brand logos for each issue-tracker provider, ported as inline SVG so
 * they stay crisp at any size and need no network fetch. Monochrome marks
 * (Linear, GitHub, Plain) render in the foreground color and flip cleanly
 * between light and dark themes; the rest carry their brand fills.
 */
...
interface SvgProps extends ProviderIconProps {
  viewBox: string;
  children: ReactNode;
}

function ProviderSvg({ size = 16, className, viewBox, children }: SvgProps) {
  return (
    <svg
      width={size}
      height={size}
...
function LinearIcon(props: ProviderIconProps) {
  return (
    <ProviderSvg
      {...props}
      viewBox="0 0 100 100"
      className={cn("text-[#222326] dark:text-foreground", props.className)}
    >
      <path
        fill="currentColor"
...
function GitHubIcon(props: ProviderIconProps) {
  return (
    <ProviderSvg
      {...props}
      viewBox="0 0 16 16"
      className={cn("text-[#1B1F23] dark:text-foreground", props.className)}
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
...
function PlainIcon(props: ProviderIconProps) {
  return (
    <ProviderSvg
      ...
      className={cn("text-[#1C1C1C] dark:text-foreground", props.className)}
    >
      <path
        fill="currentColor"
...
const PROVIDER_ICON_COMPONENTS: Record<IssueProviderType, (props: ProviderIconProps) => ReactNode> =
  {
    linear: LinearIcon,
    github: GitHubIcon,
    jira: JiraIcon,
