...
function triggerActionFailedToasts(values: Record<ToggleFeatureFlagId, boolean>): void {
  const copyText =
    "Error: Git command failed in /Users/ibrahime/Documents/Projects/codewit\n\n" +
  ...
  toastManager.add({
    type: "error",
    title: "Action failed",
    description: "Error: Git command failed in /Users/ibrahime/Documents/Projects/codewit",
    data: toastData,
  });
  toastManager.add({
    type: "error",
