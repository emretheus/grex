...
//          thread's composer draft so panels outside ChatView (file explorer,
//          editor preview, diff headers) can talk to the chatbox.
...
export const CHAT_FILE_REFERENCE_DRAG_TYPE = "application/x-codewit-file-reference";
...
// `container`. Works for both plain <pre> contents and Monaco/Shiki-highlighted
// markup because both keep one "\n" of text content per rendered line. Returns
// null when there is no actionable selection.
