// This file mostly exists because we want dev mode to say "Codewit (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.codewit.dev" : "com.t3tools.codewit";
const LAUNCHER_VERSION = 2;
const MICROPHONE_USAGE_DESCRIPTION =
  "Codewit needs microphone access so you can record voice notes and transcribe them into the chat composer.";
