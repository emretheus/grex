    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES (
          ...
          'Thread with PR',
          '{"provider":"codex","model":"gpt-5-codex"}',
          '{"number":1,"title":"Add placeholder temp files","url":"https://github.com/Emanuele-web04/openclap/pull/1","baseBranch":"main","headBranch":"codewit/greeting-1","state":"open"}',
          '2026-02-25T00:00:02.000Z',
          '2026-02-25T00:00:03.000Z',
          NULL
        )
      ...
      assert.equal(shellSnapshot.threads[0]?.lastKnownPr?.headBranch, "codewit/greeting-1");
    }),
  );
