...
export function buildPriorTranscriptBootstrapText(
  ...
  return buildImportedMessagesBootstrapText({
    ...
    intro:
      "This provider session may have been restarted without native conversation state. Use this prior Codewit transcript as context for the latest user message.",
    maxChars,
  });
}
