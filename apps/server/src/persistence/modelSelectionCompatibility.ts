...
// Imported instance ids may be runtime names rather than Codewit provider literals.
...
export function normalizePersistedModelSelection(input: unknown): unknown {
  ...
  // option rows as [{ id, value }]; Codewit stores canonical provider/options objects.
