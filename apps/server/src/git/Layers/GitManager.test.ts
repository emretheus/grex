...
> {
  return Effect.gen(function* () {
    const remoteDir = yield* makeTempDir("codewit-git-remote-");
...
function createGitHubCliWithFakeGh(scenario: FakeGhScenario = {}): {
  ...
  const execute: GitHubCliShape["execute"] = (input) => {
    ...
    if (args[0] === "pr" && args[1] === "create") {
      ...
      return Effect.succeed({
        stdout: (scenario.createdPrUrl ?? "https://github.com/pingdotgg/codewit/pull/101") + "\n",
        stderr: "",
        code: 0,
        signal: null,
        timedOut: false,
    ...
    if (args[0] === "pr" && args[1] === "view") {
      const pullRequest: FakePullRequest = scenario.pullRequest ?? {
        number: 101,
        title: "Pull request",
        url: "https://github.com/pingdotgg/codewit/pull/101",
        baseRefName: "main",
...
it.layer(GitManagerTestLayer)("GitManager", (it) => {
  it.effect("status includes PR metadata when branch already has an open PR", () =>
    Effect.gen(function* () {
      const repoDir = yield* makeTempDir("codewit-git-manager-");
            ...
            JSON.stringify([
              {
                number: 13,
                title: "Existing PR",
                url: "https://github.com/pingdotgg/codewit/pull/13",
                baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["checkout", "-b", "codewit/pr-488/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
          "git@github.com:jasonLaster/codewit.git",
        ]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/pingdotgg/codewit/pull/488",
                  baseRefName: "main",
        ...
        const status = yield* manager.status({ cwd: repoDir });
        expect(status.branch).toBe("codewit/pr-488/statemachine");
        expect(status.pr).toEqual({
          number: 488,
          title: "Rebase this PR on latest main",
          url: "https://github.com/pingdotgg/codewit/pull/488",
            ...
            JSON.stringify([
              {
                number: 22,
                title: "Merged PR",
                url: "https://github.com/pingdotgg/codewit/pull/22",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 45,
                title: "Merged PR",
                url: "https://github.com/pingdotgg/codewit/pull/45",
                baseRefName: "main",
              ...
              },
              {
                number: 46,
                title: "Open PR",
                url: "https://github.com/pingdotgg/codewit/pull/46",
                baseRefName: "main",
                headRefName: "feature/status-open-over-merged",
                state: "OPEN",
                updatedAt: "2026-01-30T10:00:00Z",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/pingdotgg/codewit/pull/90",
                  baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/pingdotgg/codewit/pull/77",
                  baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/pingdotgg/codewit/pull/89",
                  baseRefName: "main",
  ...
  it.effect("allows cross-repo PR creation when head and base branch names match", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, [
        "config",
        "remote.origin.url",
        "git@github.com:pingdotgg/codewit.git",
      ]);
      yield* runGit(repoDir, ["config", "remote.origin.pushurl", originDir]);
      yield* runGit(repoDir, ["config", "remote.fork.url", "git@github.com:octocat/codewit.git"]);
            ...
            "feature/collision": JSON.stringify([
              {
                number: 201,
                title: "Wrong repo PR",
                url: "https://github.com/someone-else/codewit/pull/201",
                baseRefName: "main",
                headRefName: "feature/collision",
                isCrossRepository: true,
                headRepository: {
                  nameWithOwner: "someone-else/codewit",
                },
                headRepositoryOwner: {
                  login: "someone-else",
                },
            ...
            "origin:feature/collision": JSON.stringify([
              {
                ...
                url: "https://github.com/pingdotgg/codewit/pull/202",
                baseRefName: "main",
                headRefName: "feature/collision",
                isCrossRepository: false,
                headRepository: {
                  nameWithOwner: "pingdotgg/codewit",
                },
                headRepositoryOwner: {
                  login: "pingdotgg",
                },
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
          "git@github.com:octocat/codewit.git",
        ]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/pingdotgg/codewit/pull/142",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["remote", "add", "fork-seed", forkDir]);
        yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
        yield* runGit(repoDir, ["checkout", "-b", "codewit/pr-142/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              "codewit/pr-142/statemachine": JSON.stringify([]),
              statemachine: JSON.stringify([
                {
                  number: 41,
                  title: "Unrelated same-repo PR",
                  url: "https://github.com/pingdotgg/codewit/pull/41",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
            ...
            JSON.stringify([
              {
                number: 88,
                title: "Add stacked git actions",
                url: "https://github.com/pingdotgg/codewit/pull/88",
                baseRefName: "main",
  ...
  it.effect("opens existing PR when create reports a duplicate branch PR", () =>
    Effect.gen(function* () {
      ...
      const existingPrUrl = "https://github.com/pingdotgg/codewit/pull/82";
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          prListSequence: ["[]"],
  ...
  it.effect("creates cross-repo PRs with the fork owner selector and default base branch", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, ["commit", "-m", "Feature commit"]);
      yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
      yield* runGit(repoDir, ["checkout", "-b", "codewit/pr-91/statemachine"]);
      yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
      yield* runGit(repoDir, [
        "config",
        "remote.fork-seed.url",
            ...
            JSON.stringify([
              {
                number: 188,
                title: "Add stacked git actions",
                url: "https://github.com/pingdotgg/codewit/pull/188",
                baseRefName: "main",
                headRefName: "statemachine",
              },
            ]),
      ...
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 64,
            title: "Local PR",
            url: "https://github.com/pingdotgg/codewit/pull/64",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 81,
            title: "Fork PR",
            url: "https://github.com/pingdotgg/codewit/pull/81",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 82,
            title: "Local Fork PR",
            url: "https://github.com/pingdotgg/codewit/pull/82",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/pingdotgg/codewit/pull/642",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/pingdotgg/codewit/pull/78",
            baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              number: 91,
              title: "Fork main PR",
              url: "https://github.com/pingdotgg/codewit/pull/91",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("codewit/pr-91/main");
        expect(result.worktreePath).not.toBeNull();
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/pingdotgg/codewit/pull/92",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("codewit/pr-92/main");
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/pingdotgg/codewit/pull/83",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 79,
            title: "Root-only PR",
            url: "https://github.com/pingdotgg/codewit/pull/79",
            baseRefName: "main",
